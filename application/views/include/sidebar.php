      ...
      <hr />
        ...
        <div class="collapse" id="master-collapse">
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('mlo'); ?>">
                <span data-feather="arrow-right" class="align-text-bottom"></span>
                MLO
              </a>
            </li>
        ...
        <div class="collapse" id="mvin-collapse">
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('payment_in'); ?>">
                <span data-feather="arrow-right" class="align-text-bottom"></span>
                Payment In
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('process_in'); ?>">
                <span data-feather="arrow-right" class="align-text-bottom"></span>
                Process In
              </a>
            </li>
        ...
        <div class="collapse" id="mvot-collapse">
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('payment_out'); ?>">
                <span data-feather="arrow-right" class="align-text-bottom"></span>
                Payment Out
              </a>
            </li>
        ...
        <div class="collapse" id="report-collapse">
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('reporting/mlo_invoicing'); ?>">
                <span data-feather="arrow-right" class="align-text-bottom"></span>
                MLO Invoicing
              </a>
            </li>

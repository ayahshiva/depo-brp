    	...
    	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          		...
          		<div class="btn-group me-2">
          			<nav aria-label="breadcrumb">
  						<ol class="breadcrumb">
    						...
    						<li class="breadcrumb-item">Reporting S-List</li> 
  						</ol>
					</nav>            
          		</div>
        	</div>
      	...
      	<div class="row">
      		<div class="container-fluid">
      			<form class="needs-validation" method="post" action="<?php echo site_url('reporting/get_s_list'); ?>" target="_blank" novalidate >
	      			<div class="card">
	      				<div class="card-header">
	      					<div class="card-title fs6">Form Laporan S-List</div>
	      				</div>
	      				<div class="card-body">
	      					<div class="mb-3">

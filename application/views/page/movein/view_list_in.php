      	...
      	<div class="row">
	      	<div class="table-responsive-sm table-responsive-md">
	      		<table class="table table-hover tabel-striped caption-top display" id="example">
	      			<caption class="fs-5">
			  				<a href="<?php echo site_url('list_in'); ?>" class="btn btn-md btn-success">
			  					<i class="bi bi-arrow-left-circle"></i> Kembali
			  				</a>
			  				<a href='<?php echo site_url() ?>list_in/add_container/<?php echo $this->uri->segment(3); ?>' class='btn btn-warning' title='Tambah Container'><i class='bi bi-clipboard-plus'></i></a>
			  				<a href='<?php echo site_url(); ?>list_in/delete_container/<?php echo $this->uri->segment(3); ?>' class='btn btn-danger' title='Hapus Container'><i class='bi bi-clipboard-minus'></i></a>
		  				</caption>
	      			<thead>

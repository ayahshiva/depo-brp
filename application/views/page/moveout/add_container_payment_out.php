	...
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container-fluid">
      	<div class="row">
      		<form class="row gy-2 gx-3 align-items-center needs-validation" action="<?php echo site_url('payment_out/simpan_container'); ?>" method="post" novalidate>
      			<div class="row">
				  	<div class="col-sm-3">
				  	...
				  	<div class="col-sm-3">
				    	...
				    	<input type="hidden" name="id_payment_out" value="<?php echo $this->uri->segment(3); ?>">
				  	</div>
				</div>
				<hr />
				<br /><br />
				...
				<div class="row">
					<div class="col-auto">
						...
						<a href="<?php echo site_url('payment_out/view_payment_out/'); ?><?php echo $this->uri->segment(3); ?>" class="btn btn-danger">Batal</a>
					</div>
				</div>
			</form>
      	</div>

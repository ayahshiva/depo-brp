	...
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    	...
    	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        	<h1 class="h2">Tambah Payment Out</h1>
        	<div class="btn-toolbar mb-2 mb-md-0">
          		<div class="btn-group me-2">
          			<nav aria-label="breadcrumb">
  						<ol class="breadcrumb">
    						<li class="breadcrumb-item"><a href="<?= site_url('payment_out'); ?>" >Payment Out</a></li>  
    						<li class="breadcrumb-item">Form Tambah Payment Out</li>
  						</ol>
					</nav>            
          		</div>
        	</div>
      ...
      <div class="container-fluid">
      	<div class="row">
      		<form class="needs-validation" method="post" action="<?php echo site_url('payment_out/simpan_payment_out'); ?>" novalidate>
				<div class="card">
					<div class="card-header">
						<div class="card-title fs-5">Form Tambah Payment Out</div>
					</div>
					<div class="card-body">
						<div class="mb-3">
							<label class="form-label">EMKL*</label>
							<select class="form-control form-select select2" name="id_emkl" id="id_emkl" required>
...
<script>
	...
	$(document).ready(function(){
	    $('#no_voyage').change(function(){
	      var id=$(this).val();
	      $.ajax({
	        url : "<?php echo site_url() . 'payment_out/get_vessel'; ?>",
	        method : "POST",
	        data : {id: id},
	        async : false,
	            dataType : 'json',
